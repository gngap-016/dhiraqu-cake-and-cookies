  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.descContainer}>
        <p className={`${styles.w50} ${styles.left}`}>{`"Dhiraqu Cake & Cookies" didirikan pada tahun 2019 oleh Endang Sapriyani yang  merupakan usaha yang berbidang di industri pastry, DhiraQu Cake & Cookies menjual berbagai cake serta cookies dengan bahan-bahan terbaik, rasa, dan banyak varian produk yang menggugah selera.  Motivasi pendirian perusahaan ini berasal dari kecintaan pada seni kuliner dan keinginan untuk berkontribusi dalam memenuhi kebutuhan pasar yang terus berkembang. `}</p>
        <p className={`${styles.w50} ${styles.right}`}>{`Dhiraqu Cake & Cookies mendedikasikan diri untuk memberikan pengalaman kuliner yang tak terlupakan kepada pelanggan mereka. Mereka percaya bahwa kualitas bahan baku yang baik, inovasi dalam desain, dan ketelitian dalam pembuatan adalah kunci kesuksesan. Selain itu, perusahaan ini berkomitmen untuk memberikan layanan pelanggan yang prima dan memastikan kepuasan pelanggan setiap kali mereka menikmati produk Dhiraqu.`}</p>
